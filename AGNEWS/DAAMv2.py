...
class MultiHeadDAAM(nn.Module):
    def __init__(self, num_layers, time_steps, feature_size, num_heads=1, c=2, eps=1e-5):
        super().__init__()
    ...
    def forward(self, x, save_attention_weights=False):
        ...
        for i in range(self.num_heads):
            ...
            if save_attention_weights:
                ...
                attention_weights_.append(self.daams[i].attention_weights)
...
class DAAMModel(nn.Module):
    def __init__(self, num_classes, num_heads=8):
        ...
        self.daam = MultiHeadDAAM(num_layers=40, time_steps=1, feature_size=5120, num_heads=num_heads) 
